...
# MODIFY!! Input
tthbb = uproot.open(indir+"tthbb.root:dnn_input").arrays(library="pd")
...
df_tthbb = tthbb[tthbb["category"] == 1].copy()
df_tthbb["category"] = 0
...
(len(df_tthbb), len(df_ttbb), len(df_ttbj), len(df_ttcc), len(df_ttlf))
...
pd_data.to_hdf(indir+"data.h5", key="df", mode="w")
