...
df_tthbb = uproot.open(indir+"tthbb+.root:dnn_input").arrays(inputvars, library="pd")
df_ttbb  = uproot.open(indir+"ttbb+.root:dnn_input").arrays(inputvars, library="pd")
df_ttcc  = uproot.open(indir+"ttcc+.root:dnn_input").arrays(inputvars, library="pd")
df_ttlf  = uproot.open(indir+"ttjj+.root:dnn_input").arrays(inputvars, library="pd")
class_names = ["tthbb","ttbb", "ttcc", "ttlf"]
...
pd_data = pd.concat([df_tthbb, df_ttbb, df_ttcc, df_ttlf])
